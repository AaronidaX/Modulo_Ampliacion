...
class Calen(models.Model):
    ...
    name = fields.Char(string="Resumen de los eventos")
    empieza = fields.Datetime(string="Empieza el")
...
class Calendario(models.Model):
    _name = 'educacion.calendario'

    name = fields.Char(string="Resumen de las reuniones")
    empieza = fields.Datetime(string="Empieza el")
    lugar = fields.Many2one('educacion.instituto', string="Lugar de reunión")
    descripcion = fields.Text(string="Descripción")
